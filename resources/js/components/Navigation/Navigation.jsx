...
class Navigation extends React.Component {
    constructor() {
        ...
        // this.showProductType = this.showProductType.bind(this);
    ...
    //         <SubMenu label={item.categories_name} key={index}>
                                                ...
                                                <Menu menuButton={<MenuButton >SẢN PHẨM</MenuButton>}>
                                                    ...
                                                    
                                                    {
                                                        this.state.categories.map(categories=>{
                                                            return (
                                                                <SubMenu label={categories.categories_name} key={categories.categories_id}>
                                                ...
                                                <UncontrolledDropdown nav inNavbar>
                                                    ...
                                                    <DropdownMenu right>
                                                        ...
                                                        <DropdownItem>
                                                            ...
                                                            {/* <Button className="btn btn-primary text-right" >Logout </Button> */}
                                                        </DropdownItem>
                                                    </DropdownMenu>
                                                </UncontrolledDropdown>
                                            </Col>
